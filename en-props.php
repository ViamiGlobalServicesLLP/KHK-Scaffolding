            ...
            <a class="product_link" href="#">
              ...
              <div class="productThumbnail">
                ...
                <div class="thumbnail_container">
                  <img src="assets/img/prodct-img/scaffolding-prop.png" alt="" class="prduct-thumbnail" />
                </div>
                ...
                <div class="img_container">
                  ...
                  <div class="cat_image_row">
                    <div class="cat_column">
                      <img src="assets/img/prodct-img/scaffolding-prop.png" alt="" class="image-types"
              ...
              <div class="prdct-title">
                <h6 class="prdct-heading">Scaffolding Prop</h6>
              </div>
              <!-- product title end -->
              ...
              <div class="productDescription">
                <div class="product-content">
                  <h2 class="entry-title">Scaffolding Prop</h2>
          ...
          <div class="cat-box">
            <a class="product_link" href="#">
              ...
              <div class="productThumbnail">
                <!-- thumbnail container start -->
                <div class="thumbnail_container">
                  <img src="assets/img/prodct-img/scaffolding-steel-props.png" alt="" class="prduct-thumbnail" />
                </div>
                <!-- thumbnail container end -->
                ...
                <div class="img_container">
                  ...
                  <div class="cat_image_row">
                    <div class="cat_column">
                      <img src="assets/img/prodct-img/scaffolding-steel-props.png" alt="" class="image-types"
                        onclick="myFunction(this);" />
                    </div>
              ...
              <!-- product title start -->
              <div class="prdct-title">
                <h6 class="prdct-heading">Scafffolding Steel Props</h6>
              </div>
              <!-- product title end -->
              ...
              <div class="productDescription">
                <div class="product-content">
                  <h2 class="entry-title">Scafffolding Steel Props</h2>
                  <!-- Inside Popup tab Gallary Content -->
                  <div class="tabContent">
                    <!-- The expanding image container -->
                    <div class="container tab-gallary">
